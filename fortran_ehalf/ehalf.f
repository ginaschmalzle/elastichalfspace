...
* Calculate chi2
* The second part of this code generates some statistics on how well the model fits 
* GPS data.  You will need a file called data.txt that contains uncertainty in 
